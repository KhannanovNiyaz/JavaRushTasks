...
public class Solution {
    ...
    public static boolean compareMD5(ByteArrayOutputStream byteArrayOutputStream, String md5) throws Exception {
        ...
        byte[] digest1 = md.digest(byteArrayOutputStream.toByteArray());
        String myHash = DatatypeConverter.printHexBinary(digest1).toLowerCase();

        if (myHash.equals(md5)) return true;
