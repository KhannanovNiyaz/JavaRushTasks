...
public class Solution implements Serializable {
    ...
    public void savedObject(OutputStream outputStream) throws IOException {
        if (this != null) {
    ...
    public Solution loadedObject(InputStream inputStream) throws IOException, ClassNotFoundException {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        new Solution(4).savedObject(fileOutputStream);
        new Solution(6).savedObject(fileOutputStream);

        Solution loadSolution1 = new Solution();
        loadSolution1.loadedObject(fileInputStream);
        loadSolution1.loadedObject(fileInputStream);
