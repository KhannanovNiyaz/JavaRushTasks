...
4. После прерывания работы нити Stopwatch (вызова метода interrupt), метод run должен
 вывести количество секунд (seconds) в консоль.
    ...
    public static class Stopwatch extends Thread {
        ...
        public void run() {
            try {
                ...
                while (!cuurentThread.isInterrupted()) {
                    Thread.sleep(1000);
                    seconds++;
                }
