...
1.2. Вторичная сортировка по дате без учета часов, минут, секунд (сверху самые новые), потом
по прибыли от положительных к отрицательным
...
////                    return res;
////                } else {
////                    Date stockDate1 = (Date) o1.get("date");
////                    Date stockDate2 = (Date) o2.get("date");
////                    SimpleDateFormat sf = new SimpleDateFormat("yyyyMMdd");
////                    int resDate = sf.format(stockDate2).compareTo(sf.format(stockDate1));
////                    if (resDate != 0) {
////                        return resDate;
////                    } else {
////                        double profit1;
...
////                            open = (double) o1.get("open");
////                            last = (double) o1.get("last");
////                            profit1 = last - open;
////                        } else {
////                            profit1 = (double) o1.get("change");
////                        }
////                        if (o2.containsKey("open")) {
////                            open = (double) o2.get("open");
////                            last = (double) o2.get("last");
////                            profit2 = last - open;
////                        } else {
...
//                Date stockDate2 = (Date) o2.get("date");
//                SimpleDateFormat sf = new SimpleDateFormat("yyyyMMdd");
//                return sf.format(stockDate2).compareTo(sf.format(stockDate1));
//            }
//        }.thenComparing(new Comparator<Stock>() {
//            @Override
//            public int compare(Stock o1, Stock o2) {
